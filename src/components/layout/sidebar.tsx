      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-y-auto">
          <nav className="p-4 space-y-1">
            ...
            <Link
              href={selectedOrgId ? `/organizations/${selectedOrgId}?tab=members` : "/organizations"}
              className={`flex items-center gap-3 px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-md ${
                isActivePath("/organizations") && (pathname.includes("/members") || pathname.includes("?tab=members")) ? "bg-gray-100 text-gray-900" : ""
              }`}
            >
